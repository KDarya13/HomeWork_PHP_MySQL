...
$works = [
    [
        'placeOfWork' => 'Эрмитаж',
        'dateBeginning' => 'mar 2021 - ',
        'dateEnd' => 'Current',
        'dutie' => 'Пугать мышей',
    ],
    [
        'placeOfWork' => 'Кафе кошек',
        'dateBeginning' => 'dec 2019 - ',
        'dateEnd' => 'mar 2021',
        'dutie' => 'Радовать глаз',
    ],
    [
        'placeOfWork' => 'Зоопарк',
        'dateBeginning' => 'may 2019 - ',
        'dateEnd' => 'dec 2019',
        'dutie' => 'Контроль качества мясных изделий',
    ],
];    
?>
<!DOCTYPE html>
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        ...
        <?php for($i = 0; $i < count($works);$i++): ?>
            <div class="w3-container">
                <h5 class="w3-opacity"><b><?php echo $works[$i]['placeOfWork'];?></b></h5>
                <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $works[$i]['dateBeginning'];?>
                <?php if($i == 0): ?>
                    <span class="w3-tag w3-teal w3-round"><?php echo $works[$i]['dateEnd'];?></span>
                <?php else: ?>
                    <?php echo $works[$i]['dateEnd'];?>
                <?php endif; ?></h6>
            <p><?php echo $works[$i]['dutie'];?></p>
            <hr>
            </div>
        <?php endfor; ?>
        </div>
